...
export default function MassivoCSAPage() {
  return (
    <SubmenuLayout title="Massivo CSA" icon={<BarChart className="h-6 w-6" />}>
      <Tabs defaultValue="acesso-rapido">
        <TabsList className="mb-4">
          <TabsTrigger value="acesso-rapido">Acesso Rápido</TabsTrigger>
          <TabsTrigger value="utilitarios-csa">Utilitários CSA</TabsTrigger>
        </TabsList>
        ...
        <TabsContent value="utilitarios-csa">
          <Card>
            <CardHeader>
              <CardTitle className="text-blue-700 dark:text-gold-500 flex items-center">
                <ExternalLink className="h-5 w-5 mr-2" />
            ...
            <CardContent>
              <SimpleLinkButton href="https://sci.csa-equatorial.com.br/Home" label="SCI - CSA" />
              <SimpleLinkButton
                href="https://grupoequatorialenergia-my.sharepoint.com/:f:/g/personal/wagno_lima_equatorialservicos_com_br/Ek2QJfi3SyNLin1CdwnjwUUBjcTtIxdqg8dRKTnMWyU9rg?e=saGHLR"
                label="Material CSA"
              />
            </CardContent>
          </Card>
