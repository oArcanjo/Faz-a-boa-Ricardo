...
export default function EspacoAtendentePage() {
  return (
    <SubmenuLayout title="Espaço do Atendente" icon={<User className="h-6 w-6" />}>
      <Tabs defaultValue="acesso-rapido">
        ...
        <TabsContent value="ferramentas">
          <Card>
            ...
            <CardContent>
              <SimpleLinkButton href="http://portaldocolaborador.equatorial.corp/home" label="Portal do Colaborador" />
              <SimpleLinkButton
                href="http://treinamento.equatorialenergia.com.br/login/index.php"
                label="Portal de Treinamento"
              />
              <SimpleLinkButton href="http://10.6.1.160/" label="Optimus M" />
              <SimpleLinkButton
                href="https://forms.office.com/pages/responsepage.aspx?id=UUVNECctOUiHsoYmSlIQpXVLerS6m75Io99nQig26PxUNjlURkFUSzBCTzRVMUtaQlhTUFNCWFpJOS4u&route=shorturl"
                label="Meu Elogio"
              />
              <SimpleLinkButton
                href="https://sistemas-hm.equatorialenergia.com.br/telaagil/dashboard"
                label="Tela Ágil"
              />
              <SimpleLinkButton href="https://equatorialenergia.learning.rocks/login" label="U. Saber" />
              <SimpleLinkButton href="https://equatorialenergia.workplace.com/work/landing/input/" label="Workplace" />
              <SimpleLinkButton href="https://equatorialenergia.edusense.app/#/" label="Aprende+" />
              <CopyToClipboardButton text="\\55ASPDCARQ01\55ATENDE\Operação" label="Mapear Pasta de Rede" />
            </CardContent>
          </Card>
        </TabsContent>
      </Tabs>
