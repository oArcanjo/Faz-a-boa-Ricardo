...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-12 items-center justify-center rounded-lg bg-slate-100 p-1 text-slate-600 dark:bg-slate-800 dark:text-slate-300",
      className,
    )}
    {...props}
  />
